...
- Step 0 is worth 1 point (starting code)
- Step 1 is worth 3 points (donut chart)
- Step 2 is worth 3 points (linked bar chart)
- Step 3 is worth 3 points (hover tooltip)
